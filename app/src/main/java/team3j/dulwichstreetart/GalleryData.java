...
public class GalleryData {
    ...
    public ArrayList<Art> GetGalleryData() {
        ...
        artArrayList.add(new Art("The Guardian Angel ","Stik","The Guardian Angel 1716 ","Marcantonio Franceschini","Stik takes portraits of wealthy, fashionable, landed gentry by Gainsborough, and strips away all pretention, leaving his simple stick figures to brilliantly convey the emotion and relationships behind the symbols of status.",R.drawable.lowresstikguardianangel,R.drawable.lowresinspiredtheguardianangel, new LatLng(51.456219, -0.076794)));
        artArrayList.add(new Art("Three Boys","Stik","Three Boys","BartolomÈ Esteban Murillo","Stik takes portraits of wealthy, fashionable, landed gentry by Gainsborough, and strips away all pretention, leaving his simple stick figures to brilliantly convey the emotion and relationships behind the symbols of status. ",R.drawable.lowresstikthreeboys,R.drawable.lowresinspiredthreeboys, new LatLng(51.445317, -0.079216)));
        artArrayList.add(new Art("Triumph of David Village","RUN","Triumph of David","Nicolas Poussin","RUN chose a detail from ëThe Translation of St Rita of Casciaí by Poussin, the saint herself. ëSt Rita, I felt, was such a destroyed soul that I want to give her a bit of peace in her life.í",R.drawable.lowresdogrun,R.drawable.lowresinspiredtriumphofdavid, new LatLng(51.449318, -0.085131)));
        ///Phlegm
        artArrayList.add(new Art("The Triumph of David 2013", "Phlegm", "The Triumph of David 1628,31", "Nicolas Poussin", "The 9 year old son of the owner of the wall helped Phlegm paint his picture.  His mum said, ëMy son loved giving him a hand and I am so grateful to him for letting him have an input.  He feels proud to be part of it and now feels very protective towards the wall.í ", R.drawable.lowresphlegm, R.drawable.lowresinspiredtriumphofdavid, new LatLng(51.451632, -0.071597)));

        //Mear One
        artArrayList.add(new Art("New World Revolution 2013", "Mear One", "The Madonna of The Rosary 1670-80", "BartolomÈ Esteban Murillo", "Mear One modernised Murilloís delicate Virgin of the Rosary by turning her and her child into powerful, mixed race  characters giving power salutes. ëEqualityí is inscribed on her halo.  ", R.drawable.lowresmearone, R.drawable.lowresinspiredtriumphofdavid, new LatLng(51.454552, -0.077042)));

        //Conor Harrington
        artArrayList.add(new Art("Fight Club", "Conor Harrington", "The Massacre of The Innocents", "Charles Le Brun", "Harringtonís fighting men in Regency costume continue their fight on 4 more walls in the USA and Costa Rica.  The bald guy wins.", R.drawable.lowresconorharrington, R.drawable.lowresinspiredthemassacreoftheinnocentsbycharleslebrun, new LatLng(51.460628, -0.075084)));

        //Agent Provocateur
        artArrayList.add(new Art("Happy Hour", "Agent Provocateur", "The Three Graces", "Sir Peter Paul Rubens ", "AP is the only stencil artist in this project.  Once cut, stencil paintings can be reproduced easily, by anyone.  The work of art AP chose to interpret was a sketch by Rubens, highly prized because it is by him alone, whereas the finished piece would have had a great deal of workshop input.", R.drawable.lowresagentprovocateur, R.drawable.lowresinspiredthethreegracesbysirpeterpaulrubens, new LatLng(51.440805, -0.056619)));
        //Ben Wilson
        artArrayList.add(new Art("Saint Catherine", "Ben Wilson", "St Catherine of Siena", "Carlo Dolci", "Wilson beautifies the disgusting old bits of chewing gum trodden into pavements.  He took the sad St Catherine of Siena and cheered her up by giving her a vision of a banana.  ", R.drawable.lowresstcatherinestone, R.drawable.lowresinspiredstcatherineofsienabycarlodolci, new LatLng(51.445672, -0.085659)));

        //David Shillinglaw
        artArrayList.add(new Art("Samson and Delilah 2013", "David Shillinglaw", "Samson and Delilah 1618", "Anthony van Dyck", "Shillinglaw took Van Dykeís Samson and Delilah ñ ëthe long hair, the scissors, the broken heart, the beautiful girl and the powerful maní and mixed them creating a single figure ësharing the same body, 2 hearts, 4 eyes and a whole lot of heartbreakí.  ", R.drawable.lowresdavidshillinglaw, R.drawable.lowresinspiredsamsonanddelilahbyanthonyvandyckinterpretedbydavidshillinglaw, new LatLng(51.452656, -0.102931)));
        //Faith47
        artArrayList.add(new Art("Europa and the Winged Bird", "Faith47", "Europa and the Bull", "Guido Reni", "The absence of the bull and the introduction of a guiding bird are suggestive of a premonition of the abduction to come, her inner emotions and thoughts or perhaps a new interpretation of the ancient fable. ", R.drawable.lowreseuropaandthebull, R.drawable.lowresinspiredeuropaandthebullbyguidoreni, new LatLng(51.465731, -0.061023)));
        //Inkie, Pure Evil, AP is going to have custom view for each for zoomed in view of each artist  NEEDS A CUSTOM setup
        artArrayList.add(new Art("Old Nun's Head Mural", "Inkie, Pure Evil and AP", "St Catherine of Siena", "Carlo Dolci", "Three different internationally renowned street artists have painted a panel each on The Old Nunís Head pub in Nunhead.  They have taken their inspiration from the same painting in Dulwich Picture Gallery, one of a nunís head, St Catherine of Siena, painted in 1665 by Carlo Dolci. ", R.drawable.lowresoldnunsheadmurals, R.drawable.lowresinspiredstcatherineofsienabycarlodolci, new LatLng(51.465289, -0.059352)));
        //MadC need better scaled image may crop width    NEEDS A CUSTOM setup
        artArrayList.add(new Art("Vase With Flowers 2013", "MadC", "Vase with Flowers c1720", "Jan van Huysum", "One of only two female artist in the project, MadC, took elements from a 17th century Dutch flower painting, the insects, tulips and butterflies, and added them to her tag, creating an astonishingly beautiful back to a tennis practice wall in Belair Park.  ", R.drawable.lowresmadc, R.drawable.lowresinspiredvasewithflowersbyjanvanhuysum, new LatLng(51.441452, -0.091381)));
        //Reka
        artArrayList.add(new Art("Europa and the Bull c1700", "Reka", "Europa and the Bull 2013", "Guido Reni", "Rekaís  Europa from Reniís ëEuropa and the Bullí beautifies a wall of a South London pub.  Her hair curls delicately around its windows.", R.drawable.lowresreka, R.drawable.lowresinspiredeuropaandthebull, new LatLng(51.427863, -0.086302)));
        //Remi Rough and System // NEEDS A CUSTOM setup
        artArrayList.add(new Art("Girl at a Window 2013", "Remi Rough and System", "Girl at a Window 1645", "Rembrandt van Rijn", "Systemís modernised ëGirl at a Windowí by Rembrandt, leans out from Remi Roughs abstraction of ëThe Triumph of Davidí by Poussin.  This ordinary young girl in a hoodie and cap with spray cans at her elbow, parallels Rembrandtís 17th century serving girl.  ", R.drawable.lowresremiroughandsystem, R.drawable.lowresinspiredgirlatthewindow, new LatLng(51.461675, -0.079872)));
        //ROA
        artArrayList.add(new Art("Landscape with Sportsmen and Game 2013", "ROA", "Landscape with Sportsmen and Game c.1665", "Adam Pynacker", "ROA chose a detail of Pynackerís ëSportsman with Gameí - a shitting dog that Pynacker placed in the foreground of his painting.  ROAís version has provoked some criticism, people being more shockable in the 21st century than in the 17th century.", R.drawable.lowresdoginlandscape, R.drawable.lowresinspiredlandscapewithsportsman, new LatLng(51.467224, -0.072160)));
        //RUN
        artArrayList.add(new Art("The Translation of Saint Rita of Cascia", "RUN", "The Translation of Saint Rita of Cascia c1630", "Nicolas Poussin", "RUN chose a detail from ëThe Translation of St Rita of Casciaí by Poussin, the saint herself. ëSt Rita, I felt, was such a destroyed soul that I want to give her a bit of peace in her life.í  ", R.drawable.lowresrunstrita, R.drawable.lowresinspiredtranslationofstrita, new LatLng(51.437918, -0.054667)));
        //STIK
        artArrayList.add(new Art("The Fall of Man", "Stik", "The Fall of Man", "Pieter Coecke van Aelst", "Stik takes portraits of wealthy, fashionable, landed gentry by Gainsborough, and strips away all pretention, leaving his simple stick figures to brilliantly convey the emotion and relationships behind the symbols of status. ", R.drawable.lowresstikfallofman, R.drawable.lowresinspiredfallofman, new LatLng(51.453060, -0.078765)));
        artArrayList.add(new Art("Eliza and Mary Davidson", "Stik", "Eliza and Mary Davidson", "Tilly Kettlesm", "Stik takes portraits of wealthy, fashionable, landed gentry by Gainsborough, and strips away all pretention, leaving his simple stick figures to brilliantly convey the emotion and relationships behind the symbols of status.  ", R.drawable.lowresstikelizaandmarydavidsontilly, R.drawable.lowresinspiredelizaandmarydavidson, new LatLng(51.447416, -0.076093)));
        artArrayList.add(new Art("Eliza and Mary Linley", "Stik", "Eliza and Mary Linley", "Thomas Gainsborough", "Stik takes portraits of wealthy, fashionable, landed gentry by Gainsborough, and strips away all pretention, leaving his simple stick figures to brilliantly convey the emotion and relationships behind the symbols of status.  ", R.drawable.lowresstikelizabethandmary, R.drawable.lowresinspiredelizabethandlinley, new LatLng(51.446414, -0.073434)));
        artArrayList.add(new Art("A Couple in a Landscape", "Stik", "A Couple in a Landscape", "Thomas Gainsborough", "Stik takes portraits of wealthy, fashionable, landed gentry by Gainsborough, and strips away all pretention, leaving his simple stick figures to brilliantly convey the emotion and relationships behind the symbols of status.  ", R.drawable.lowresstikacoupleinlandscape, R.drawable.lowresinspiredacoupleinalandscape, new LatLng(51.456109, -0.076058)));

        //Thierry Noir
        artArrayList.add(new Art("Context", "Thierry Noir", "Joseph Receiving Pharaohís Ring", "Giambattista Tiepolo", "Famed for painting the Berlin Wall at risk of his life for 10 years in the 1980s, Noirís simple style was born of need for speed and clarity.  His versions of the characters in Tiepoloís ëJoseph Receiving Pharaohís Ringí interact similarly, but with Noir, size relates to importance as in medieval times.   ", R.drawable.lowresnoir, R.drawable.lowresinspiredthierrynoir, new LatLng(51.445228, -0.079050)));
        //Walter Kershaw
        artArrayList.add(new Art("Finished Wall", "Walter Kershaw", "Landscape with Windmills Near Haarlem", "Jacob Van Ruisdael", "ëLandscape with Windmills near Haarlemí painted first by Jacob Van Ruisdael in c 1650, then copied by John Constable in c 1830, then copied by Walter Kershaw as a huge mural in 2014.  Spot the differences!  ", R.drawable.lowreswalterlandscape, R.drawable.lowresinspiredlandscapewithwindmill, new LatLng(51.467546, -0.072552)));
    ...
    public static ArrayList<Artist> GetArtistsDataReal(Activity context) {
        ...
        data.add(new Artist("Ben Wilson", "Ben Wilson, born in Cambridge in 1963, started working as an artist on a large scale in wood, creating life size wooden sculptures hidden in woods and forests. Since 2004 he has been painstakingly painting on discarded chewing gum in London.\n\n" +
                ...
                "Wilsonsís work encompasses a wide subject matter, often relating to the immediate contextual environment or to people that he meets on his travels.", "", R.drawable.profilebenwilson));

        data.add(new Artist("David Shillinglaw", "Born in 1982 in Saudi Arabia to British parents, David Shillinglaw is currently based in London. At home in both the streets and in the studio, Shillinglaw applies his fine arts graphic skills to everything from small hand-made books to large murals focusing on the follies and wisdom of the human race.\n\nAlthough he was formally educated with a degree in Fine Art, Shillinglaw contends that the best lessons that heís learned have been self-taught. With mixed-media work that has been exhibited in galleries throughout the world including China, Japan and Turkey, Shillinglaw draws on material from both ancient mythology and popular culture. His favourite surfaces include objects such as old road signs and doors that he finds in the streets.", "www.cargocollective.com/davidshillinglaw", R.drawable.profiledavidshillinglaw));
...
//        //Conor Harrington
//        artArrayList.add(new Art("Fight Club","Conor Harrington","The Massacre of The Innocents","Charles Le Brun","Harringtonís fighting men in Regency costume continue their fight on 4 more walls in the USA and Costa Rica.  The bald guy wins.",R.drawable.lowresconorharrington,R.drawable.lowresconorharrington));
//        //David Shillinglaw
...
//        //Mear One
//        artArrayList.add(new Art("New World Revolution 2013","Mear One","The Madonna of The Rosary 1670-80","BartolomÈ Esteban Murillo","Mear One modernised Murilloís delicate Virgin of the Rosary by turning her and her child into powerful, mixed race  characters giving power salutes. ëEqualityí is inscribed on her halo.  ",R.drawable.lowresmearone,R.drawable.lowresmearone));
//        ///Phlegm
//        artArrayList.add(new Art("The Triumph of David 2013","Phlegm","The Triumph of David 1628,31","Nicolas Poussin","The 9 year old son of the owner of the wall helped Phlegm paint his picture.  His mum said, ëMy son loved giving him a hand and I am so grateful to him for letting him have an input.  He feels proud to be part of it and now feels very protective towards the wall.í ",R.drawable.lowresphlegm,R.drawable.lowresphlegm));
//        //Reka
//        artArrayList.add(new Art("Europa and the Bull c1700","Reka","Europa and the Bull 2013","Guido Reni","Rekaís  Europa from Reniís ëEuropa and the Bullí beautifies a wall of a South London pub.  Her hair curls delicately around its windows.",R.drawable.lowresreka,R.drawable.lowresreka));
//        //Remi Rough and System // NEEDS A CUSTOM setup
//        artArrayList.add(new Art("Girl at a Window 2013","Remi Rough and System","Girl at a Window 1645","Rembrandt van Rijn","Systemís modernised ëGirl at a Windowí by Rembrandt, leans out from Remi Roughs abstraction of ëThe Triumph of Davidí by Poussin.  This ordinary young girl in a hoodie and cap with spray cans at her elbow, parallels Rembrandtís 17th century serving girl.  ",R.drawable.lowresremiroughandsystem,R.drawable.lowresremiroughandsystem));
//        //ROA
//        artArrayList.add(new Art("Landscape with Sportsmen and Game 2013","ROA","Landscape with Sportsmen and Game c.1665","Adam Pynacker","ROA chose a detail of Pynackerís ëSportsman with Gameí - a shitting dog that Pynacker placed in the foreground of his painting.  ROAís version has provoked some criticism, people being more shockable in the 21st century than in the 17th century.",R.drawable.lowresdoginlandscape,R.drawable.lowresdoginlandscape));
//        //RUN
...
//        artArrayList.add(new Art("Three Boys","Stik","Three Boys","BartolomÈ Esteban Murillo","",R.drawable.lowresstikthreeboys,R.drawable.lowresstikthreeboys));
...
//
//        //Thierry Noir
//        artArrayList.add(new Art("Context","Thierry Noir","Joseph Receiving Pharaohís Ring","Giambattista Tiepolo"," ",R.drawable.lowresnoir,R.drawable.lowresnoir));
//        //Walter Kershaw
