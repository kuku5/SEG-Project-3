...
public class GalleryData {
    ...
    public ArrayList<Art> GetGalleryData() {
        ...
        //Faith47
        artArrayList.add(new Art("Europa and the Winged Bird", "Faith47", "Europa and the Bull", "Guido Reni", "The absence of the bull and the introduction of a guiding bird are suggestive of a premonition of the abduction to come, her inner emotions and thoughts or perhaps a new interpretation of the ancient fable. ", R.drawable.lowreseuropaandthebull, R.drawable.lowresinspiredeuropaandthebullbyguidoreni,new LatLng(51.465731, -0.061023),"783165415098988", "Consort Road SE15", false, new String[]{"www.faith47.com"}));
        ...
        //STIK
        artArrayList.add(new Art("The Fall of Man", "Stik", "The Fall of Man", "Pieter Coecke van Aelst", "Stik takes portraits of wealthy, fashionable, landed gentry by Gainsborough, and strips away all pretention, leaving his simple stick figures to brilliantly convey the emotion and relationships behind the symbols of status. ", R.drawable.lowresstikfallofman, R.drawable.lowresinspiredfallofman,new LatLng(51.453060, -0.078765),"783165481765648", "The Moorings Townley Road/Beauval Road, London, SE22 8SW", false, new String[]{"www.stik.org.uk", "https://www.youtube.com/watch?v=RCVECYTJ-0U"}));
        artArrayList.add(new Art("Eliza and Mary Davidson", "Stik", "Eliza and Mary Davidson", "Tilly Kettlesm", "Stik takes portraits of wealthy, fashionable, landed gentry by Gainsborough, and strips away all pretention, leaving his simple stick figures to brilliantly convey the emotion and relationships behind the symbols of status.  ", R.drawable.lowresstikelizaandmarydavidsontilly, R.drawable.lowresinspiredelizaandmarydavidson,new LatLng(51.447416, -0.076093),"783165488432314", "150 Court Lane, London, SE21 7EB", false, new String[]{"www.stik.org.uk"}));
        artArrayList.add(new Art("Eliza and Mary Linley", "Stik", "Eliza and Mary Linley", "Thomas Gainsborough", "Stik takes portraits of wealthy, fashionable, landed gentry by Gainsborough, and strips away all pretention, leaving his simple stick figures to brilliantly convey the emotion and relationships behind the symbols of status.  ", R.drawable.lowresstikelizabethandmary, R.drawable.lowresinspiredelizabethandlinley,new LatLng(51.446414, -0.073434),"783165538432309", "184 Court Lane, London, SE21 7EB", false, new String[]{"www.stik.org.uk"}));
        artArrayList.add(new Art("A Couple in a Landscape", "Stik", "A Couple in a Landscape", "Thomas Gainsborough", "Stik takes portraits of wealthy, fashionable, landed gentry by Gainsborough, and strips away all pretention, leaving his simple stick figures to brilliantly convey the emotion and relationships behind the symbols of status.  ", R.drawable.lowresstikacoupleinlandscape, R.drawable.lowresinspiredacoupleinalandscape,new LatLng(51.456109, -0.076058),"783165478432315", "On the side of Property In estate agent on the corner of Hansler Road and 133 Lordship Lane, London, SE22 8HX", false, new String[]{"www.stik.org.uk", "https://www.youtube.com/watch?v=RqYOzLoHBf0"}));

        //Thierry Noir
        artArrayList.add(new Art("Context", "Thierry Noir", "Joseph Receiving Pharaoh’s Ring", "Giambattista Tiepolo", "Famed for painting the Berlin Wall at risk of his life for 10 years in the 1980s, Noir’s simple style was born of need for speed and clarity.  His versions of the characters in Tiepolo’s ‘Joseph Receiving Pharaoh’s Ring’ interact similarly, but with Noir, size relates to importance as in medieval times.   ", R.drawable.lowresnoir, R.drawable.lowresinspiredthierrynoir,new LatLng(51.445228, -0.079050),"783165548432308", "The Bowling Building, Dulwich Park, London, SE21", false, new String[]{"www.galerie-noir.de", "https://www.youtube.com/watch?v=jGZ9Ou_xFfo"}));
        //Walter Kershaw
        artArrayList.add(new Art("Finished Wall", "Walter Kershaw", "Landscape with Windmills Near Haarlem", "Jacob Van Ruisdael", "‘Landscape with Windmills near Haarlem’ painted first by Jacob Van Ruisdael in c 1650, then copied by John Constable in c 1830, then copied by Walter Kershaw as a huge mural in 2014.  Spot the differences!  ", R.drawable.lowreswalterlandscape, R.drawable.lowresinspiredlandscapewithwindmill,new LatLng(51.467546, -0.072552),"783165585098971", "166 Bellenden Road, London, SE15 4QY", false, new String[]{"http://www.walterkershaw.co.uk/"}));
    ...
    public static ArrayList<Artist> GetArtistsDataReal(Activity context) {
        ...
        data.add(new Artist("Ben Wilson", "Ben Wilson, born in Cambridge in 1963, started working as an artist on a large scale in wood, creating life size wooden sculptures hidden in woods and forests. Since 2004 he has been painstakingly painting on discarded chewing gum in London.\n\n" +
                ...
                "Wilsonsís work encompasses a wide subject matter, often relating to the immediate contextual environment or to people that he meets on his travels.", "http://en.wikipedia.org/wiki/Ben_Wilson_(artist)", R.drawable.profilebenwilson));
